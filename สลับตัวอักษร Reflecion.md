...
```text
First We need input reciver then print it by lower case and print it backword
```
...
Step 2:print it backward and it wrong
Step 3:print it backword and lowertcase
```
...
```text
have input reciver print it backward and made it all lowercase
```
