...
```text
first I have 2 input then split it use map split then find average of 2 input and print result
```
...
```
Step 1:have 2 input
Step 2:split input use map split
Step 3:find average of 2 input
Step 4:print result
```
